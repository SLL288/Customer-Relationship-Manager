...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200">
      <aside className="hidden w-64 flex-none border-r border-slate-200 bg-white/90 backdrop-blur md:block">
        <div className="flex items-center gap-3 px-5 py-5">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-slate-900 text-white font-semibold">
            CRM
          </div>
          <div>
